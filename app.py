...
def extract_token_from_response(data, region):
    ...
    elif region in ["BR", "US", "SAC", "NA", "BD"]:
...
def get_jwt_token_sync(region):
    ...
    endpoints = {
        ...
        "BD": "https://jwt-token-api-by-ajay-seven.vercel.app/token?uid=4423929770&password=JOBAYAR_CODX-TXWQZKEXO"
    }    
    url = endpoints.get(region, endpoints["BD"])
    with jwt_lock:
        try:
...
def get_api_endpoint(region):
    endpoints = {
        ...
        "BD": "https://clientbp.ggwhitehawk.com/GetPlayerPersonalShow"
    }
